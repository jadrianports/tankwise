...
// + its legend together. The price landscape is the most informative
// thing on the map, so it defaults to visible; this stays a one-click
// strip-back to route + chosen stops for a viewer who wants a cleaner
// view. >=44px touch target, matching other icon-only controls.
