...
// Bounds mirror the backend's own validation exactly
// (routing/serializers.py::VehicleSerializer) so the UI can never
// construct an out-of-bounds request -- the DRF serializer stays the
// authoritative validator, this is a UX guardrail only.
const MPG_MIN = 1;
const MPG_MAX = 100;
...
// MPG, tank-range, and starting-fuel what-if sliders. Every drag
...
// call even though this component re-renders on every tick.
