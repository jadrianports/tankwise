...
// Composes the sidebar's section slots in a fixed content order. Each
// section is a self-contained feature component that reads shared solve
// state from useRoutePlanContext() -- this file never inlines a section's
// internals, so each section's own file can be replaced without ever
// touching Sidebar.tsx or App.tsx.
//
// The `print-hide` marker (print.css) is the only hook a print
